 ...
 */
export function resolveRealm(hostname) {
 ...
 */
export function getRealm(hostname) {
 ...
 */
export function getAdminBase(realm, hostname) {
    if (realm)
        return `${ENV_KC_URL}/admin/realms/${realm}`;
 ...
 * @param hostname  Hostname pour extraction automatique
 */
export function getOidcBase(realm, hostname) {
    if (realm)
        return `${ENV_KC_URL}/realms/${realm}/protocol/openid-connect`;
 ...
 * }
 */
export function resolveRealmFromRequest(request) {
 ...
 */
export function clearRealmCache() {
    _cachedRealm = null;
}
// ── Export par défaut ─────────────────────────────────────
export default {
