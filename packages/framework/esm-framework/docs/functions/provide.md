...
Defined in: [packages/framework/esm-config/src/module-config/module-config.ts:279](https://github.com/egen/egen-esm-core/blob/main/packages/framework/esm-config/src/module-config/module-config.ts#L279)
