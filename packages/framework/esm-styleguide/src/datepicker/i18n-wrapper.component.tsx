 ...
 */
export function I18nWrapper(props: I18nProviderProps): React.ReactElement {
  return React.createElement(I18nProvider as (props: I18nProviderProps) => React.ReactElement, props);
}
