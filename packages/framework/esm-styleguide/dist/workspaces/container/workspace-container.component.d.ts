 ...
 * @deprecated Workspace container is no longer needed with workspace v2.
 */
export declare function WorkspaceContainer({ contextKey, overlay, showSiderailAndBottomNav, additionalWorkspaceProps, actionMenuProps, }: WorkspaceContainerProps): import("react/jsx-runtime").JSX.Element;
