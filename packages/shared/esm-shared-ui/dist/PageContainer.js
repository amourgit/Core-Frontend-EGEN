...
export function PageContainer({ children, maxWidth = 'xl', className, padded = true }) {
    return (_jsx("div", { className: cn('egen-page-container', padded && 'egen-page-container--padded', className), style: { maxWidth: MAX_WIDTHS[maxWidth], margin: '0 auto', width: '100%' }, children: children }));
}
